  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "fade-in": "fade-in 400ms var(--ease-out-expo, ease-out)",
        "fade-up": "fade-up 500ms var(--ease-out-expo, ease-out)",
        "slide-in-right": "slide-in-right 400ms var(--ease-out-expo, ease-out)",
