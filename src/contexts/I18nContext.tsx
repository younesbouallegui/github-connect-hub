...
const en: Dict = {
  ...
  "nav.executive": "Executive Center",
  ...
  "nav.section.govern": "Govern",

  // Executive Command Center
  "exec.title": "Executive Command Center",
  "exec.subtitle": "Strategic overview of operations, reliability, and risk",
  "exec.live": "Live",
  "exec.healthScore": "Global health score",
  "exec.healthGood": "Operations are stable across your scope.",
  "exec.healthWarn": "Minor degradations detected — review recommendations.",
  "exec.healthBad": "Critical conditions in progress — immediate attention required.",
  "exec.activeIncidents": "Active incidents",
  "exec.slaPeriod": "SLA (period)",
  "exec.target": "Target",
  "exec.mttr": "MTTR",
  "exec.last7d": "Last 7 days",
  "exec.regional": "Regional posture",
  "exec.regionalSubtitle": "Service health by region",
  "exec.services": "Services",
  "exec.aiRecs": "AI recommendations",
  "exec.aiRecsSubtitle": "Prioritized actions",
  "exec.askAI": "Discuss with AI",
  "exec.topAlerts": "Top firing alerts",
  "exec.topAlertsSubtitle": "Highest impact alerts in your scope",

  // Dashboards (builder)
  "dashboards.title": "Dashboards",
  "dashboards.subtitle": "Build, save, and share custom dashboards",
  "dashboards.addWidget": "Add widget",
  "dashboards.wallboard": "Wallboard mode",
  "dashboards.exitWallboard": "Exit wallboard",
  "dashboards.templates": "Templates",
  "dashboards.empty": "No widgets yet. Add a widget or pick a template.",
  "dashboards.added": "Widget added",
  "dashboards.saved": "Dashboard saved",
  "dashboards.templateApplied": "Template applied",

  // Alert Center
  "alerts.title": "Alert Center",
  "alerts.subtitle": "Unified, correlated alerts across your assigned infrastructure",
  "alerts.live": "Live",
  ...
  "alerts.total": "Total",
  "alerts.correlated": "Correlated groups",
  "alerts.search": "Search alerts, hosts, triggers…",
  "alerts.empty": "No alerts match your filters.",
  "alerts.acknowledge": "Acknowledge",
  "alerts.escalate": "Escalate",
  "alerts.mute": "Mute",
  "alerts.unmute": "Unmute",
  "alerts.close": "Resolve",
  "alerts.openRoom": "Open incident room",
  "alerts.rootCause": "Suggested root cause",
  "alerts.affected": "Affected services",
  "alerts.trigger": "Trigger",
  "alerts.firedAt": "Fired at",
  "alerts.count": "Occurrences (24h)",
  "alerts.tags": "Tags",
  "alerts.onCall": "On-call now",
  "alerts.audit": "Recent activity",
  "alerts.bulk": "{n} selected",
  "alerts.bulkAck": "Ack all",
  "alerts.bulkMute": "Mute all",
  "alerts.notAllowed": "Your role does not allow this action.",
  "alerts.acked": "Alert acknowledged.",
  "alerts.muted_done": "Alert muted.",
  "alerts.unmuted_done": "Alert unmuted.",
  "alerts.escalated": "Alert escalated to on-call.",
  "alerts.closed": "Alert resolved.",
...
const fr: Dict = {
  ...
  "nav.section.operate": "Exploitation",
  "nav.section.observe": "Observation",
  "nav.section.configure": "Configuration",
  "nav.section.govern": "Gouvernance",

  "exec.title": "Centre de commandement exécutif",
  "exec.subtitle": "Vue stratégique des opérations, de la fiabilité et des risques",
  "exec.live": "Temps réel",
  "exec.healthScore": "Score de santé global",
  "exec.healthGood": "Les opérations sont stables sur votre périmètre.",
  "exec.healthWarn": "Légères dégradations détectées — consultez les recommandations.",
  "exec.healthBad": "Conditions critiques en cours — action immédiate requise.",
  "exec.activeIncidents": "Incidents actifs",
  "exec.slaPeriod": "SLA (période)",
  "exec.target": "Cible",
  "exec.mttr": "MTTR",
  "exec.last7d": "7 derniers jours",
  "exec.regional": "Posture régionale",
  "exec.regionalSubtitle": "Santé des services par région",
  "exec.services": "Services",
  "exec.aiRecs": "Recommandations IA",
  "exec.aiRecsSubtitle": "Actions priorisées",
  "exec.askAI": "Discuter avec l'IA",
  "exec.topAlerts": "Alertes prioritaires",
  "exec.topAlertsSubtitle": "Alertes à plus fort impact",

  "dashboards.title": "Tableaux de bord",
  "dashboards.subtitle": "Créez, enregistrez et partagez vos tableaux",
  "dashboards.addWidget": "Ajouter un widget",
  "dashboards.wallboard": "Mode mur",
  "dashboards.exitWallboard": "Quitter le mur",
  "dashboards.templates": "Modèles",
  "dashboards.empty": "Aucun widget. Ajoutez-en un ou choisissez un modèle.",
  "dashboards.added": "Widget ajouté",
  "dashboards.saved": "Tableau enregistré",
  "dashboards.templateApplied": "Modèle appliqué",

  "alerts.title": "Centre d'alertes",
  "alerts.subtitle": "Alertes unifiées et corrélées sur votre infrastructure",
  "alerts.live": "Temps réel",
  "alerts.firing": "Actives",
  "alerts.acknowledged": "Acquittées",
  "alerts.muted": "Silencées",
  "alerts.resolved": "Résolues",
  "alerts.total": "Total",
  "alerts.correlated": "Groupes corrélés",
  "alerts.search": "Rechercher alertes, hôtes, déclencheurs…",
  "alerts.empty": "Aucune alerte ne correspond aux filtres.",
  "alerts.acknowledge": "Acquitter",
  "alerts.escalate": "Escalader",
  "alerts.mute": "Silencer",
  "alerts.unmute": "Réactiver",
  "alerts.close": "Résoudre",
  "alerts.openRoom": "Ouvrir la salle d'incident",
  "alerts.rootCause": "Cause racine probable",
  "alerts.affected": "Services impactés",
  "alerts.trigger": "Déclencheur",
  "alerts.firedAt": "Déclenchée à",
  "alerts.count": "Occurrences (24h)",
  "alerts.tags": "Étiquettes",
  "alerts.onCall": "Astreinte en cours",
  "alerts.audit": "Activité récente",
  "alerts.bulk": "{n} sélectionnée(s)",
  "alerts.bulkAck": "Tout acquitter",
  "alerts.bulkMute": "Tout silencer",
  "alerts.notAllowed": "Votre rôle ne permet pas cette action.",
  "alerts.acked": "Alerte acquittée.",
  "alerts.muted_done": "Alerte silencée.",
  "alerts.unmuted_done": "Alerte réactivée.",
  "alerts.escalated": "Alerte escaladée à l'astreinte.",
  "alerts.closed": "Alerte résolue.",
